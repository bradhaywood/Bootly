...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{BOOTLY_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{BOOTLY_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
bootly_server.pl - Catalyst Testserver

=head1 SYNOPSIS

bootly_server.pl [options]
